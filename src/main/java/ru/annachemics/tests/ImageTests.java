...
public class ImageTests extends BaseTest {
    private final String PATH_TO_IMAGE = "src/test/resources/picture.jpeg";
    ...
    @Test
    void uploadFileTest(Object token) {
    ...
    void uploadFileImageTest() {
        uploadedImageId = given()
                .headers("Authorization", token)
                .multiPart("image", new File("src/test/resources/picture.jpeg"))
                .expect()
                .statusCode(200)
                .when()
